...
var DEFAULT_SETTINGS = {
  ...
  redirect_uri_mobile: "urn:ietf:wg:oauth:2.0:oob",
  // Out-of-band for mobile manual code entry
  refresh_token: "",
  token_type: "",
...
var OAuthCodeEntryModal = class extends import_obsidian2.Modal {
  constructor(app, authUrl, onSubmit) {
    super(app);
...
`;
  ...
  async _performMobileAuthorization() {
    ...
    return new Promise((resolve, reject) => {
      const modal = new OAuthCodeEntryModal(this.app, authUrl, async (code) => {
        try {
  ...
  async syncNewsletters() {
    if (!this.settings.access_token && !this.settings.refresh_token) {
      new import_obsidian2.Notice("Please configure Gmail authentication in settings first.");
      return;
    }
  ...
  display() {
    ...
    if (import_obsidian2.Platform.isMobile) {
      containerEl.createEl("div", {
        text: "\u{1F4F1} Running on mobile - using manual code entry for authentication",
